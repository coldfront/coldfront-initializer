...
from coldfront.core.models import CustomField, CustomFieldChoiceSet
    ...
    def load_data(self, records):
        ...
        for cf_name, cf_details in records.items():
            ...
            if created:
                ...
                if cf_details.get("required_action", None) is not None:
                    custom_field.required_action = cf_details["required_action"]
